...
Usage: import the module (see Jupyter notebookas for examples), or run from
...
class ProductConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + (apple, banana, feldschloesschen, huerlimann, ramen, redbull, tuc, tuna)
